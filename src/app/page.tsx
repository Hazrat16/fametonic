      ...
      <div className="w-full md:w-1/2 flex flex-col justify-center px-6 md:px-[0px] pt-28 md:pt-0">
        ...
        <div className="flex flex-col-reverse md:flex-col">
          <div className="w-full md:w-1/2 mb-6 md:mb-0">
            <button className="w-full h-[40px] rounded-[10px] bg-[#FC004E] text-white font-figtree font-bold text-[20px] px-10 py-2 shadow-[2px_2px_10px_#00E7F9] mb-2 flex items-center justify-center gap-0.5">
              Get Started
              <ForwardButtonIcon height="10" width="20" />
            </button>
          ...
          <div className="flex flex-col md:flex-col items-center text-center md:text-start md:items-start">
            <p className="text-[12px] leading-[22px] text-[#ABABAB] my-[20px] font-medium">
              By clicking &quot;Get Started&quot;, you agree with Terms and
              Conditions, Privacy Policy, Subscription <br />
              Terms
            </p>
